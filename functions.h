...
// parse input file
int parseInputFile(std::vector<isolate*> *pop, std::vector<cog*> *accessoryLoci, double lower, double upper, std::vector<int> *samplingList, std::vector<std::string> *serotypeList, std::vector<std::string> *scList, std::vector<std::string> *cogList, char *inputFilename, char * vtCogName,int&, bool useCogList);
